...
public class ShreeyaTejFinalProjectVF {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        int NextInt = 0; //initializing NextInt for ints
        double NextDouble = 0; //initializing NextDouble for doubles
        ...
        do { // do while loop which controls how many times the user plays - as long as flag = true
            ...
            if (Category.contains("or")) {//more flexible because they might put word, words, Words, Word
                ...
                double AnswerDouble = 0; //same process as previous games pretty much, just with different variables
                while (scanFile.hasNext()) {
                    AnswerDouble = scanUser.nextDouble();
                    System.out.println("Double is " + AnswerDouble);
                    while (scanFile.hasNext()) {

                        NextDouble = scanFile.nextDouble();
                        if (NextDouble == (AnswerDouble)) {
                            RightAnswer(score, times);
                            score++;
                            times++;
                            break;
